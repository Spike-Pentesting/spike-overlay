...
#we want to support ruby20 and ruby21 until January, but meh, what's a week?
...
each_ruby_prepare() {
	...
	#force all metasploit executables to ruby20, ruby18 is not supported anymore and ruby20 is not supported yet
