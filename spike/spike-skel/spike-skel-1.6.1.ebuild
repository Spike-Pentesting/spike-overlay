...
xdg-desktop-menu install --novendor /usr/share/spike/directory/spike-spike.directory /usr/share/spike/desktop/Get_Live_Help.desktop
...
pkg_prerm() {
	if [ -x "/usr/bin/xdg-desktop-menu" ]; then
                                        xdg-desktop-menu uninstall /usr/share/spike/directory/spike-spike.directory
		xdg-desktop-menu /usr/share/spike/directory/*.directory /usr/share/spike/desktop/*.desktop
	fi
}
